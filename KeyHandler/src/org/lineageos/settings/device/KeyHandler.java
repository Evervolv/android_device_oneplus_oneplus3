...
public class KeyHandler implements DeviceKeyHandler {
        ...
        public void handleMessage(Message msg) {
            if (msg.arg1 == FLIP_CAMERA_SCANCODE) {
                ...
                Intent intent = new Intent(
                        evervolv.content.Intent.ACTION_SCREEN_CAMERA_GESTURE);
    ...
    public KeyEvent handleKeyEvent(KeyEvent event) {
        ...
        if (isSliderModeSupported) {
            ...
            boolean proximityWakeCheckEnabled = EVSettings.System.getInt(
                    mContext.getContentResolver(), EVSettings.System.PROXIMITY_ON_WAKE,
